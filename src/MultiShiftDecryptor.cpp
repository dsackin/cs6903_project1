...
const std::string MultiShiftDecryptor::getKeyString() const {
...
const std::vector<int>& MultiShiftDecryptor::getKeyShifts() const {
	return keyShifts;
}

const std::string MultiShiftDecryptor::getExplanation() const {
